...
<TITLE>动漫电影信息网站</TITLE>     <!-- Bootstrap core CSS -->
...
<SPAN class="icon-bar"></SPAN><SPAN class="icon-bar"></SPAN><SPAN class="icon-bar"></SPAN></BUTTON> 
          <A class="navbar-brand" href="#" target="_blank">动漫电影信息网站</A> 
        </DIV>
...
<UL class="nav nav-sidebar">
  ...
  <LI><A class="accordion-toggle collapsed" href="#" data-toggle="collapse" data-target="#mastersubmenu">地区管理</A>
  <UL class="nav collapse" id="mastersubmenu" style="padding-left: 20px;">
    <LI><A href="areaAdd.php">添加地区</A></LI>
    <LI><A href="areaList.php">查询地区</A></LI>
  </UL>
  </LI>

   <LI><A class="accordion-toggle collapsed" href="#" data-toggle="collapse" data-target="#mastersubmenu1">动漫电影信息管理</A>
  <UL class="nav collapse" id="mastersubmenu1" style="padding-left: 20px;">
    <LI><A href="videoAdd.php">添加动漫电影信息</A></LI>
    <LI><A href="videoList.php">查询动漫电影信息</A></LI>
  </UL>
  </LI>


  <LI><A href="commentList.php">留言管理</A></LI>

  <LI><A href="userList_page.php">用户管理</A></LI>
